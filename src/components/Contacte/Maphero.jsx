...
const WorldMapContactSection = () => {
  return (
    <div className="bg-indigo-900 text-white min-h-screen font-sans py-14">
      ...
      <div className="container mx-auto px-6 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 items-center border-t border-indigo-800 pt-10">
          <div className="text-center md:text-left">
            <p className="mb-5 text-lg font-medium tracking-wide text-indigo-200">
              Follow us
            </p>
            <div className="flex justify-center md:justify-start gap-5">
              <a
                href="#"
                className="bg-black rounded-full p-3 hover:bg-gray-800 transition-colors duration-300 flex items-center justify-center"
              >
                <FacebookIcon />
              </a>
              <a
...
export default WorldMapContactSection;
